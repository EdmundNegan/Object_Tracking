# Description: This file contains the functions that control the robot's movement
...
def move_to_face(list_of_facepos,robot_pos, robot, origin):
    """
